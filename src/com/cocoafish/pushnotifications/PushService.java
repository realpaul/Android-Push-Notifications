...
public class PushService extends Service
{
	...
	public static String			MQTT_CLIENT_ID = "cf";
	...
	// Notification title
	public static String			NOTIF_TITLE = "Cocoafish"; 	
	// Notification id
	...
	private void showNotification(String text) {
		...
		n.icon = com.cocoafish.pushnotifications.R.drawable.icon;
		n.when = System.currentTimeMillis();

		Intent intent = new Intent(getBaseContext(), ArrivalActivity.class);
		intent.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP|Intent.FLAG_ACTIVITY_NEW_TASK);
		intent.putExtra("notification_message", text);
		PendingIntent pi = PendingIntent.getActivity(getBaseContext(), R.string.app_name, intent, PendingIntent.FLAG_UPDATE_CURRENT);

		// Change the name of the notification here
		n.setLatestEventInfo(getBaseContext(), NOTIF_TITLE, text, pi);
